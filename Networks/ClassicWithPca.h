#ifndef CLASSIC_WITH_PCA_H
#define CLASSIC_WITH_PCA_H
...
class ClassicWithPca {

    public:

        ClassicWithPca (int neuronAmount, double inpVal, double timeConstant, double timeStep, double leakingDecayRate, 
